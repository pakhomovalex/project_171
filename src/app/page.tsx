...
export const projects: ProjectCardType[] = [{
  ...
  subtitle: `Авторська картина, що символізує 
  незламність українського духу навіть у найтемніші часи`,
  category: 'Мистецтво',
  description: `“Світло крізь тріщини” — це авторська картина, 
  народжена в часи війни.`,
  images: ['/project-image.png', '/project-image.png', '/project-image.png'],
  fundraising_goal: `Для захисників Сил спеціальних операцій Збройних сил України,
   які зараз боронять нашу`,
  price: 10000,
  percent: 100,
  lastDate: '02.08.2025',
},
{
  ...
  fundraising_goal: `Для захисників Сил спеціальних операцій Збройних сил України,
   які зараз боронять нашу землю від загарбників та дуже потребують мобільні
    майстерні оголошуємо збір коштів! Ці майстерні призначені для технічного
    обслуговування та ремонту різних видів автомобільної техніки, включаючи 
    колісні транспортні засоби. Вони дозволять поліпшити можливості 
    та потенціал з ремонту та обслуговування броне- та автотехніки,
    яку Україна отримує у якості військово-технічної допомоги.Це готове
    комплексне рішення, яке дозволяє проводити ремонт та обслуговування
    техніки всього за кілька годин, неподалік від фронтової лінії.
    Майстерня оснащена необхідним обладнанням для швидкого ремонту 
    автомобільної техніки навіть в умовах польових умов. Машини 
    мають шиномонтажне обладнання, генератор, зварювальний апарат,
    пуско-зарядний пристрій, пневмосистему, інструменти та інше 
    необхідне обладнання для комфортної роботи.`,
  price: 10000,
